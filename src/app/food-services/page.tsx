    ...
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-muted/20">
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-primary via-primary/90 to-primary/70 border-b border-border/40">
        ...
        <div className="container mx-auto px-4 py-12 md:py-16 text-center relative">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-primary-foreground mb-3 tracking-tight">
          ...
          <Badge className="mt-4 bg-primary-foreground text-primary px-6 py-2 text-base md:text-lg font-bold shadow-lg">
